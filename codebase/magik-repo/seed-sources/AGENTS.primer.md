> **Project Harness primer.** This project uses [magik-repo](https://github.com/) — a four-component layout with knowledge, workspace, codebase, and worker scaffolding in a single repo.
