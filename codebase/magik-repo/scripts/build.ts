 ...
 *
 * This script intentionally does NOT read from the harness root. The harness
 * root is a *user* of magik-repo (eats its own dogfood) and stops carrying
 * framework files at <harness>/.cursor/. All framework content lives in this
 * folder and only this folder.
 */
